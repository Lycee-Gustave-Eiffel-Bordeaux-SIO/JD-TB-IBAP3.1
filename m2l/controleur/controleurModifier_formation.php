...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    $idForma = isset($_POST['idForma']) ? $_POST['idForma'] : null;
    ...
    if ($idForma && $intitule && $description && $duree && $date_ouverture && $date_cloture && $effectif_max) {
        FormationDao::ModifierFormation($idForma, $intitule, $description, $duree, $date_ouverture, $date_cloture, $effectif_max);
    } else {
